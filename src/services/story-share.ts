...
export const shareTexts = {
  ...
  linkedin: (data: StoryData) =>
    ...
    `\nData via SITREP - Open source geopolitical intelligence`,
...
export function getShareUrls(data: StoryData): Record<string, string> {
  ...
  return {
    ...
    reddit: `https://reddit.com/submit?url=${encodeURIComponent(url)}&title=${encodeURIComponent(`${data.countryName} Intelligence Brief - SITREP`)}`,
