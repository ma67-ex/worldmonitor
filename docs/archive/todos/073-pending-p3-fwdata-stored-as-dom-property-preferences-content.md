...
- 2026-09-06: Fixed — replaced the `_fwData` DOM-property cast with a `pendingFwData` closure variable scoped to `renderPreferences`, read/written by the same click-handler branches. `npm run typecheck` passes.
