...
**Everything else from the original audit** (R2, Anthropic, Axiom, Brave/Exa via SearXNG, ScrapeCreators via Reddit OAuth) turned out to be safe — see commits landed 2026-08-25 for the actual swaps, and `docs/tasks/abdullah/README.md` for the index entry.
