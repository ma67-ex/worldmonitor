...
Real-time global intelligence dashboard. TypeScript SPA (Vite + Preact) with 184 top-level TypeScript component files, 23+ Vercel Edge API endpoint entries, a Tauri desktop app with Node.js sidecar, and a Railway relay service. Aggregates geopolitics, military, finance, climate, cyber, maritime, and aviation data across 39 freshness-tracked source groups.
...
│   ├── services/           # Business logic (240 service modules and domain directories)
