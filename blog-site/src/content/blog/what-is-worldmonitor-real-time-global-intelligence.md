...
The public dashboard exposes 58 map-layer types, 500+ curated news feeds backed by 548+ observed upstream hosts, country briefs, instability scores, chokepoints, infrastructure, markets, disasters, and watchlists. Every layer is available on the free plan, and the dashboard can be opened without an account.
